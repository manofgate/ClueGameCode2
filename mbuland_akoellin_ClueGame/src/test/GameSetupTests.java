...
public class GameSetupTests {
	...
	public void loadPeopletest() {
		...
		Assert.assertEquals(1, hum.size());
		Assert.assertEquals("Mr mober", hum.get(0).getName());
		Assert.assertEquals(Color.red, hum.get(0).getColor());
	}
