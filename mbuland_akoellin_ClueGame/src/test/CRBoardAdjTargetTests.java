...
public class CRBoardAdjTargetTests {
	...
	{
		// Test a corner
		List<Integer> testList = board.getAdjList(board.calcIndex(0, 0));
	...
	{
		// TEST DOORWAY RIGHT 
		List<Integer> testList = board.getAdjList(board.calcIndex(11, 6));
	...
	public void testAdjacencyWalkways()
	{
		...
		List<Integer> testList = board.getAdjList(board.calcIndex(0, 4));
		System.out.println("Test List: " + testList);
		System.out.println("0,4 = " + board.calcIndex(0, 4));
	...
	public void testAdjacencyDoorways()
	{
		...
		List<Integer> testList = board.getAdjList(board.calcIndex(4, 4));
